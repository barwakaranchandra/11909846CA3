...
<head>
    ...
    <!--====== Title ======-->
    <title>Bank Details by KARAN BARWA | Home</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                           <h3 style="color: black;padding-right: 50px;">Bank Details by KARAN BARWA</h3>
    ...
    <footer id="footer" class="footer-area bg_cover" style="background-image: url(assets/images/footer-bg.jpg)">
        <div class="container">
            <div class="footer-copyright text-center">
                <p class="text">© <?php echo date('Y');?> Bank Details by KARAN BARWA - 11909846</p>
            </div>
        </div> <!-- container -->
    </footer>
